  ...
  <body>
    ...
    <br>
        ...
        <div class="container">
            ...
            <div class="row">
            @if($resultados != null)
                @foreach($resultados as $flor)
                    <div class="col-sm-2">
                        <div style="width: 10rem;">
                            <a href="" data-toggle="modal" data-target="#exampleModalCenter"><img class="card-img-top rounded-circle" src="{{ url('img/fotosFlores/'.$flor->foto_flor) }}" alt="{{ $flor->nome_flor }}" height="150" width="300"></a>
                            <div class="card-body">
